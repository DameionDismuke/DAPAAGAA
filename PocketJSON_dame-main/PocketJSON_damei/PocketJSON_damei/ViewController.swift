...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let output: Monster? = genericParseJSON()
        print(output!)
    }
    ...
    func genericParseJSON<T:Decodable>() -> T?
    {
        ...
        do {
            ...
            let mons = try decoder.decode(T.self, from: jsonData1)
            ...
            //monster = try JSONDecoder().decode(T.self, from: jsonData1)
